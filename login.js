document.addEventListener('DOMContentLoaded', function() {
    ...
    menuButton.addEventListener('click', function () {
        ...
        overlay.classList.add('active'); // 어두운 배경 활성화
        menuButton.classList.add('disabled');  // 메뉴 버튼 클릭 불가
    });
    
    // 사이드바 닫기 버튼 클릭 시 사이드바 닫기
    closeButton.addEventListener('click', function () {
        sidebar.classList.remove('open');  // 사이드바 닫기
        overlay.classList.remove('active'); // 어두운 배경 비활성화
        menuButton.classList.remove('disabled');  // 메뉴 버튼 클릭 가능
    });
    
    // 어두운 배경 클릭 시 사이드바 닫기 (선택적)
